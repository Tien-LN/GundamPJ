      ...
      <div className="adminCourses__lists">
        {courses.map((item, index) => (
          <div className="adminCourses__box" key={index}>
            {item.deleted == false ? (
              <button
                className="adminCourses__delete"
                onClick={() => {
              ...
              <div className="adminCourses__deleted">
                <button
                  className="adminCourses__deleted-restore"
                  onClick={() => {
                ...
                <button
                  className="adminCourses__deleted-perm"
                  onClick={() => {
            ...
            <div className="adminCourses__box-head">
              ...
              <div className="adminCourses__box-headInfo">
                <div className="adminCourses__box-headInfo--name">
                  <b>Tên: </b>
                  {item.name}
                </div>
                <div className="adminCourses__box-headInfo--startDate">
                  <b>Ngày bắt đầu: </b>
                  {format(new Date(item.startDate), "dd/MM/yyyy")}
                </div>
                <div className="adminCourses__box-headInfo--endDate">
                  <b>Ngày kết thúc: </b>
                  {format(new Date(item.endDate), "dd/MM/yyyy")}
                </div>
                <div className="adminCourses__box-headInfo--teacher">
                  <b>Giáo viên: </b>
                  {item.teacher.name}
                </div>
                <div className="adminCourses__box-headInfo--price">
                  <b>Giá: </b>
            ...
            <div className="adminCourses__box-tail">
              <div className="adminCourses__box-tailInfo--description">
                <b>Mô tả: </b>
                {item.description ? item.description : "Chưa nhập"}
              </div>
            </div>
          </div>
        ))}
