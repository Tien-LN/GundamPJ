...
export default function App({ initialValue, onChange }) {
  return (
    <Editor
      apiKey="l3u76820hb1dy1l70hpdhq3mc5x0hb9isvdk039lkptdv4xw"
      init={{
        plugins: [
          "anchor",
          "autolink",
        ...
        toolbar:
          "undo redo | blocks fontfamily fontsize | bold italic underline strikethrough | link image media table mergetags | addcomment showcomments | spellcheckdialog a11ycheck typography | align lineheight | checklist numlist bullist indent outdent | emoticons charmap | removeformat | latex ",
