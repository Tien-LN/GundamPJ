...
function ModalEnrollment({fnClose}){
    ...
    useEffect(() => {
        const fetchApi = async() => {
            try {
                const res = await axios.get("http://localhost:3000/api/enrollments/my-account", {
    ...
    return (
        <>
            ...
            <div className="enrollments__request" id="modalEnrollShow" onClick={handleClickOutSide}>
                <div className="enrollments__showRequests">
                    <h2 className="enrollments__showRequests-title">Các yêu cầu đã gửi</h2>
